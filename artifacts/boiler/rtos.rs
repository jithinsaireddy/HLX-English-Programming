...
// Auto-generated HLX-RTOS skeleton for Boiler-A
#![no_std]
#![no_main]
...
pub extern "C" fn app_main() {
    let _sensor_task = Task::new().name("sensor").stack_size(1024).start(move || {
        ...
        let mut ts_ms: u64 = 0;
        loop {
            // TODO: read sensor 'pressure' into val
            let val: f32 = 0.0;
            buf[idx] = val; idx = (idx + 1) % N; ts_ms += 200 as u64;
            FreeRtosUtils::delay(Duration::ms(200));
        }
    });
