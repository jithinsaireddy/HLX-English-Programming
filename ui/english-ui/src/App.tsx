...
print sum`},
    ...
    {name:'HTTP GET (example.com)', text:`http get "https://example.com" store in body\nprint body`},
    {name:'HTTP POST (echo)', text:`set url to "https://httpbin.org/post"\nset payload to '{"hello":"world"}'\nhttp post url with body payload store in resp\nprint resp`},
    {name:'IMPORTURL (example.com)', text:`import from url "https://example.com" store in content\nprint content`},
    {name:'Async HTTP GET', text:`set url to "https://example.com"\nasync http get url await store in body\nprint body`},
    {name:'IMPORTURL (local file)', text:`set path to "README.md"\nimport from url path store in content\nprint content`},
